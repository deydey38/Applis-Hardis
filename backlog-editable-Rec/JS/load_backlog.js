...
var ITOP_URL 				= 'https://itoptest.hardis.fr/itop-preprod';
var ITOP_WS_URL 			= ITOP_URL + "/webservices/rest.php?version=1.3";
var iTopTicketUrl 			= 'https://itoprec.hardis.fr/itop/pages/UI.php?operation=details&class=UserRequest&id=';
var iTopPbUrl				= 'https://itoprec.hardis.fr/itop/pages/UI.php?operation=details&class=Problem&id=';
var TICKET_URL_PID_HARDIS 	= 'http://www.hardis.fr/forward/bugredir.html?b=';
var urlBackLogList 			= 'https://itoprec.hardis.fr/itop/pages/UI.php?operation=search&filter=%3D';
var urlIncidentBackLogList 	= 'https://itoprec.hardis.fr/itop/pages/UI.php?operation=search&filter=%3D%3D';
var urlRequestBackLogList 	= 'https://itoprec.hardis.fr/itop/pages/UI.php?operation=search&filter=';
...
function refreshSuccessfull(data){
	...
	else
	{
		...
		//GENARATION DE RAPPORT
		//ajouter onclick pour reneration de rapport
		$('#startRapport').attr('onclick', 'startRapport()');


		//est on en genaration de rapport
...
/***
* fonction replissage tableau a traiter/ en attente vidageTab = 1 pour vider les tableaux et nb
***/
function remplirTableauATEA(object, vidageTab){
	...
	$.each(tabTicketAT, function(index, value){
		...
		//remplacer les ' dans le titre sinon probleme!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		str += '<td><img src="./img/edit.png" alt="modifierTicket" onclick="fadeInPopup(\''+ value['typeTicket'] + '\', '+ value['id']+' , \''+ value['refitop'] +'\', \'' + value['titre'].replace(/'/g, " ") + '\', \''+ value['datecrea'] +'\', \''+ value['dateMaj'] +'\', \'\', \''+ value['rawTeam'] +' \', \''+ value['agent'] +'\', \''+ value['statut'] +'\' , \''+ value['serviceId']+'\', \' '+ value['datePlan']+'\' )" /></td></tr>';
	...
	$.each(lesTicketsEnAtt, function(index, value){
		...
		str += '<td>'+ value['agent'] +'</td>';
		str += '<td>'+ value['public_log'] +'</td>';
		if(value['statut']!="En attente d'approbation")
...
function remplirTableauTicketFerme(object, vidageTab){
	...
	$.each(lesTicketsF, function(index, value){
		...
		if(value['statut'] =='Résolu'){
			//remplacer ' dans titre sinon probleme !!!!!!!!!!!!!!!!!
			str += '<td><img src="./img/edit.png" alt="modifierTicket" onclick="fadeInPopup(\''+ value['typeTicket'] + '\', '+ value['id']+', \''+ value['refitop'] +'\', \'' + value['titre'].replace(/'/g, " ") + '\', \''+ value['datecrea'] +'\', \''+ value['dateMaj'] +' \', \'' + value['dateferm'] + '\', \''+ value['rawTeam'] +' \', \''+ value['agent'] +'\', \'Résolu\' , \''+ value['serviceId']+'\', \'\')" /></td></tr>';
		}else{
			str +="<td></td></tr>"
		}
...
* POUR LA MODIF
*****/
function fadeInPopup(typeTicket, id, ref, titre, dateCrea, dateMaj, dateFerm, team, agent, statut, service, datePlan){
	var tabTeam = new Array;
	//set date picker to french
	...
	$('#div_dateHeure').hide();
	$('#datepicker').val("");
	$('#heure option:selected').removeAttr('selected');
	$('#h00').attr('selected', 'selected');
	$('#minute option:selected').removeAttr('selected');
	$('#m00').attr('selected', 'selected');
	$("#div_resolved").hide();
	$('#errorMessageAgent').val('');
	$('#errorMessageTeam').val('');
	$('#codReso').val('');
	$('#eltService').val('');
	$('#errorMessageDatePlan').val('');
	$('#errorMessageSolution').val('');
	$('#solution').val('');
	$('#comp').val("");
	$('#compv').val("");
	$('#popupTicket #statut option').remove();
	$("#divdf").hide();
	$('#team option:selected').removeAttr('selected');
	$('#agent').removeAttr("disabled");
	$('#team').removeAttr("disabled");

	if(statut=="Assigné équipe" || statut== "Résolu" || statut.startsWith("En attente") || statut == "En attente d'approbation")
		$('#agent').attr("disabled","disabled");

	if(statut== "Résolu" || statut.startsWith("En attente") || statut == "En attente d'approbation")
		$('#team').attr("disabled","disabled");

	//show elements
	$("#shadowing").show();
	$('#popupTicket').fadeIn();
	$("#popupTicket").css('z-index', '6');


	$("#typeTicket").val(typeTicket);
	console.log($("#typeTicket").val());

	if(statut=='En attente planifiée'){
		$('#heure option:selected').removeAttr('selected');
		$('#minute option:selected').removeAttr('selected');
		var dateP = datePlan.substr(9,2)+'/'+datePlan.substr(6,2)+'/'+datePlan.substr(1,4);
		var heureP = datePlan.substr(12,2);
		var minP = datePlan.substr(15,2);
		$('#div_dateHeure').show();
		$('#datepicker').val(dateP);
		var idh='h'+heureP;
		var idmin='m'+minP;
		// console.log(idh);
		// $('#'+idmin).attr('selected', 'selected');
	...
	//repmlissage champs
	//Json request link team contact
	aJSON = {
		operation: 'core/get',
		'class': 'lnkTeamToContact',
		key: 'SELECT tm FROM lnkTeamToContact AS tm JOIN Contact AS ctc ON tm.contact_id = ctc.id WHERE ctc.status = "Active" AND  ctc.finalclass="Person" AND ctc.email LIKE "%hardis%"',
		output_fields: 'team_name'
	};
	//Json request for resolutioncode pour remplir champ code de résolution
	rcJSON = {
		operation: 'core/get',
		'class': 'ResolutionCode',
		key: 'SELECT rc FROM ResolutionCode AS rc WHERE rc.service_id='+service,
		output_fields: 'friendlyname'
	};
	//Json request ServiceElement pour remplir champ element de service
	seJSON = {
		operation: 'core/get',
		'class': 'ServiceElement',
		key: 'SELECT se FROM ServiceElement AS se WHERE se.service_id='+service,
		output_fields: 'friendlyname'
	};
	...
	$.ajax({
		...
		success: function (data) {
			$.each(data['objects'], function(index, value){
				if(tabTeam.indexOf(value['fields']['team_name']) == -1 && value['fields']['team_name'].indexOf("INACTIF") ==-1 && !(value['fields']['team_name'].startsWith("Notification")) && !(value['fields']['team_name'].startsWith("z")) && !(value['fields']['team_name'].startsWith("IBM")) && !(value['fields']['team_name'].startsWith("Comité")) ){
					$('#team').append("<option id='"+ value['fields']['team_name'].replace(/ /g, "_") +"'>"+value['fields']['team_name']+"</option>");
					tabTeam.push(value['fields']['team_name']);
				}
			});
			var i = team.replace(/ /g, "_");
			if(i.charAt(i.length-1)=='_')
				i=i.substr(0,i.length-1);
			var optionT = document.getElementById(i);
			optionT.selected="selected";
			$("#popupTicket h2").text('Ticket '+ ref +' - '+ titre);
			$("#dc").val(dateCrea);
			$("#dmaj").val(dateMaj);
			if(dateFerm!=''){
				$("#df").val(dateFerm);
			...
			$("#idTicket").val(id);
			$("#popupTicket #agent").val(agent);
			var optionsStatut= getOptionsByStatut(statut);
			$.each(optionsStatut, function(index, value){
				$("#popupTicket #statut").append("<option id='"+value+"'>"+value+"</option>");
			});
			//ajax for resolution code
			$.ajax({
				type: "POST",
				url: ITOP_WS_URL,
				dataType: 'jsonp',
				data: { auth_user: login, auth_pwd: pwd, json_data: JSON.stringify(rcJSON) },
				crossDomain: 'true',
				success: function (data) {
					$.each(data['objects'], function(index, value){
						$("#popupTicket #codReso").append("<option id='"+value['key']+"'>"+value['fields']['friendlyname']+"</option>");
					});
					//ajax for service element
					$.ajax({
						type: "POST",
						url: ITOP_WS_URL,
						dataType: 'jsonp',
						data: { auth_user: login, auth_pwd: pwd, json_data: JSON.stringify(seJSON) },
						crossDomain: 'true',
						success: function (data) {
							$.each(data['objects'], function(index, value){
								$("#popupTicket #eltService").append("<option id='"+value['key']+"'>"+value['fields']['friendlyname']+"</option>");
							});
						},
						error: function (data) {
								document.getElementById("backlogHardisListId").innerHTML = "Erreur lors de la récupération des éléments. Connectez-vous à iTop";
	...
	//sauvegarde des valeur initiales
	saveTeam = team.trim();
	saveAgent = agent.trim();
	saveStatut = statut.trim();
	saveDateP = dateP;
	saveHP = heureP;
	saveMinP = minP;
}
...
*****/
/**
* get option disponible selon le statut actuel
**/
function getOptionsByStatut(statut){
	var options=null;
	switch(statut) {
    case "Assigné agent":
		options=["Assigné agent", "Assigné équipe", "En attente client", "En attente interne", "En attente planifiée", "Résolu"];
        break;
    case "Assigné équipe":
        options=["Assigné équipe", "Assigné agent", "Résolu", "En attente client", "En attente interne", "En attente planifiée"];
        break;
	case "Résolu":
        options=["Résolu", "Assigné équipe"];
        break;
	case "En attente client":
        options=["En attente client", "Assigné agent", "Assigné équipe", "Résolu"];
        break;
	case "En attente interne":
        options=["En attente interne", "Assigné agent", "Assigné équipe", "Résolu"];
        break;
	case "En attente planifiée":
        options=["En attente planifiée", "Assigné agent", "Assigné équipe", "Résolu"];
        break;
    default:
        options=[statut];
	}
...
/**
* selection d'un nouveau statut
**/
function statutSelected(statut){
	$("#errorMessageAgent").val("");
	$("#errorMessageAgent").fadeOut();
	$("#errorMessageTeam").val("");
	$("#errorMessageTeam").fadeOut();
	$("#errorMessageStatut").val("");
	$("#errorMessageStatut").fadeOut();

	switch(statut) {
    case "Assigné agent":
		$('#div_resolved').hide();
		$('#errorMessageDatePlan').hide();
		$('#div_dateHeure').hide();
		//$('#agent').val("");
		$('#agent').removeAttr("disabled");
		$('#team').removeAttr("disabled");
    ...
    case "Assigné équipe":
		...
		$('#agent').val("");
        $('#agent').attr("disabled","disabled");
        $('#team').removeAttr("disabled","disabled");
        break;
	case "Résolu":
		$('#div_dateHeure').hide();
		$('#errorMessageDatePlan').hide();
...
function getSeason() {
    ...
    hiver = 'dec,december,jan,january,feb,february,12,1,2,';
    print = 'mar,march,apr,april,may,3,4,5,';
    ete = 'jun,june,jul,july,aug,august,6,7,8,';
    aut = 'sep,september,oct,october,nov,november,9,10,11,';
    season = 'unknown';
    if (hiver.indexOf(month) != -1) {
        season = 'hiver';
    } else if (print.indexOf(month) != -1) {
        season = 'printemps';
    } else if (ete.indexOf(month) != -1) {
        season = 'été';
    } else if (aut.indexOf(month) != -1) {
        season = 'automne';
    }
    return season;
}
